package com.lambdaschool.africanmarketplace.config;
...
//    @Value ("${OAUTHCLIENTID:}")
    static String CLIENT_ID = System.getenv("OAUTHCLIENTID");

//    @Value("${OAUTHCLIENTSECRET:}")
    static String CLIENT_SECRET = System.getenv("OAUTHCLIENTSECRET");
